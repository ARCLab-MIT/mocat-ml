...
function cfgMC = setup_MCconfig(rngseed,ICfile)
    ...
    filename_save = sprintf('%sTLEIC_year%i_rand%i.mat', output_folder, cfgMC.time0.Year, rngseed);
    cfgMC.filename_save = filename_save;
    cfgMC.n_save_checkpoint = inf;  % Save the results every n_save_checkpoint step
